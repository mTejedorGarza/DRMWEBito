...
namespace Spartane.Core.Classes.Detalle_Planes_de_Suscripcion_Especialistas
{
    ...
    public class Detalle_Planes_de_Suscripcion_Especialistas: BaseEntity
    {
        ...
        public virtual Spartane.Core.Classes.Frecuencia_de_pago_Especialistas.Frecuencia_de_pago_Especialistas Frecuencia_de_Pago_Frecuencia_de_pago_Especialistas { get; set; }
        [ForeignKey("Contrato")]

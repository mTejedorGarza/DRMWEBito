...
namespace Spartane.Core.Classes.Registro_de_Asistencia_Telefonica
{
    /// <summary>
    ...
    public class Registro_de_Asistencia_Telefonica: BaseEntity
    {
        ...
        public virtual Spartane.Core.Classes.Spartan_User.Spartan_User Usuario_que_llama_Spartan_User { get; set; }
        [ForeignKey("Nombre_Paciente")]
        public virtual Spartane.Core.Classes.Pacientes.Pacientes Nombre_Paciente_Pacientes { get; set; }
        ...
        public virtual Spartane.Core.Classes.Asuntos_Asistencia_Telefonica.Asuntos_Asistencia_Telefonica Asunto_de_la_Llamada_Asuntos_Asistencia_Telefonica { get; set; }
        [ForeignKey("Atendio")]
        public virtual Spartane.Core.Classes.Spartan_User.Spartan_User Atendio_Spartan_User { get; set; }
        [ForeignKey("Estatus")]
        public virtual Spartane.Core.Classes.Estatus_Llamadas.Estatus_Llamadas Estatus_Estatus_Llamadas { get; set; }

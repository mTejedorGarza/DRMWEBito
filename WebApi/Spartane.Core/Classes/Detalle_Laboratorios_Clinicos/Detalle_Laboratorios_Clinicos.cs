...
namespace Spartane.Core.Classes.Detalle_Laboratorios_Clinicos
{
    /// <summary>
    ...
    public class Detalle_Laboratorios_Clinicos: BaseEntity
    {
        ...
        public virtual Spartane.Core.Classes.Actividades_del_Evento.Actividades_del_Evento Folio_Actividades_del_Evento_Actividades_del_Evento { get; set; }

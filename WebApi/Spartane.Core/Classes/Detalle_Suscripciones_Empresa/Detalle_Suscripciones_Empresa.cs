...
namespace Spartane.Core.Classes.Detalle_Suscripciones_Empresa
{
    /// <summary>
    ...
    public class Detalle_Suscripciones_Empresa: BaseEntity
    {
        ...
        public virtual Spartane.Core.Classes.Frecuencia_de_pago_Empresas.Frecuencia_de_pago_Empresas Frecuencia_de_Pago_Frecuencia_de_pago_Empresas { get; set; }
        [ForeignKey("Estatus")]

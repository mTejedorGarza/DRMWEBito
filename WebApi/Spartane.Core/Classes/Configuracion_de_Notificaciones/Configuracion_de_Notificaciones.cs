...
namespace Spartane.Core.Classes.Configuracion_de_Notificaciones
{
    /// <summary>
    ...
    public class Configuracion_de_Notificaciones: BaseEntity
    {
        ...
        public virtual Spartane.Core.Classes.Tipo_de_Notificacion.Tipo_de_Notificacion Tipo_de_Notificacion_Tipo_de_Notificacion { get; set; }
        [ForeignKey("Tipo_de_Accion")]
        public virtual Spartane.Core.Classes.Tipo_de_Accion_Notificacion.Tipo_de_Accion_Notificacion Tipo_de_Accion_Tipo_de_Accion_Notificacion { get; set; }
        [ForeignKey("Tipo_de_Recordatorio")]
        public virtual Spartane.Core.Classes.Tipo_de_Recordatorio_Notificacion.Tipo_de_Recordatorio_Notificacion Tipo_de_Recordatorio_Tipo_de_Recordatorio_Notificacion { get; set; }
        [ForeignKey("Fecha_a_validar")]
        public virtual Spartane.Core.Classes.Nombre_del_campo_en_MS.Nombre_del_campo_en_MS Fecha_a_validar_Nombre_del_campo_en_MS { get; set; }
        [ForeignKey("Estatus")]

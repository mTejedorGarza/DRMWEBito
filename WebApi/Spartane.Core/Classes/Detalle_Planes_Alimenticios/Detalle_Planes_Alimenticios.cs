...
namespace Spartane.Core.Classes.Detalle_Planes_Alimenticios
{
    /// <summary>
    ...
    public class Detalle_Planes_Alimenticios: BaseEntity
    {
        ...
        public virtual Spartane.Core.Classes.Planes_Alimenticios.Planes_Alimenticios Folio_Planes_Alimenticios_Planes_Alimenticios { get; set; }
        ...
        [ForeignKey("Platillo")]
        public virtual Spartane.Core.Classes.Platillos.Platillos Platillo_Platillos { get; set; }

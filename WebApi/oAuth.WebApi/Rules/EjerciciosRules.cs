...
{
    public static class EjerciciosRules
    {
        public static bool EjecutarValidacionesBeforePost(Spartane.Core.Classes.Ejercicios.Ejercicios obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPost(Spartane.Core.Classes.Ejercicios.Ejercicios obj)
        {

            //NEWBUSINESSRULE_AFTERPOST//
        }

        public static bool EjecutarValidacionesBeforePut(Spartane.Core.Classes.Ejercicios.Ejercicios obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPut(Spartane.Core.Classes.Ejercicios.Ejercicios obj)
        {

...
{
    public static class Detalle_de_IngredientesRules
    {
        public static bool EjecutarValidacionesBeforePost(Spartane.Core.Classes.Detalle_de_Ingredientes.Detalle_de_Ingredientes obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPost(Spartane.Core.Classes.Detalle_de_Ingredientes.Detalle_de_Ingredientes obj)
        {

            //NEWBUSINESSRULE_AFTERPOST//
        }

        public static bool EjecutarValidacionesBeforePut(Spartane.Core.Classes.Detalle_de_Ingredientes.Detalle_de_Ingredientes obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPut(Spartane.Core.Classes.Detalle_de_Ingredientes.Detalle_de_Ingredientes obj)
        {
        ...
        public static void EjecutarValidacionesAfterDelete(Spartane.Core.Classes.Detalle_de_Ingredientes.Detalle_de_Ingredientes obj)
        {

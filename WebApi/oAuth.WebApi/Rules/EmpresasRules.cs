...
{
    public static class EmpresasRules
    {
        public static bool EjecutarValidacionesBeforePost(Spartane.Core.Classes.Empresas.Empresas obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPost(Spartane.Core.Classes.Empresas.Empresas obj)
        {

            //NEWBUSINESSRULE_AFTERPOST//
        }

        public static bool EjecutarValidacionesBeforePut(Spartane.Core.Classes.Empresas.Empresas obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPut(Spartane.Core.Classes.Empresas.Empresas obj)
        {

...
{
    public static class IngredientesRules
    {
        public static bool EjecutarValidacionesBeforePost(Spartane.Core.Classes.Ingredientes.Ingredientes obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPost(Spartane.Core.Classes.Ingredientes.Ingredientes obj)
        {

            //NEWBUSINESSRULE_AFTERPOST//
        }

        public static bool EjecutarValidacionesBeforePut(Spartane.Core.Classes.Ingredientes.Ingredientes obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPut(Spartane.Core.Classes.Ingredientes.Ingredientes obj)
        {

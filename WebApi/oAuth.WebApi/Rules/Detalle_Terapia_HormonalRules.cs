...
{
    public static class Detalle_Terapia_HormonalRules
    {
        public static bool EjecutarValidacionesBeforePost(Spartane.Core.Classes.Detalle_Terapia_Hormonal.Detalle_Terapia_Hormonal obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPost(Spartane.Core.Classes.Detalle_Terapia_Hormonal.Detalle_Terapia_Hormonal obj)
        {

            //NEWBUSINESSRULE_AFTERPOST//
        }

        public static bool EjecutarValidacionesBeforePut(Spartane.Core.Classes.Detalle_Terapia_Hormonal.Detalle_Terapia_Hormonal obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPut(Spartane.Core.Classes.Detalle_Terapia_Hormonal.Detalle_Terapia_Hormonal obj)
        {
        ...
        public static void EjecutarValidacionesAfterDelete(Spartane.Core.Classes.Detalle_Terapia_Hormonal.Detalle_Terapia_Hormonal obj)
        {

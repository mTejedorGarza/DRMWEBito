...
{
    public static class Unidades_de_MedidaRules
    {
        public static bool EjecutarValidacionesBeforePost(Spartane.Core.Classes.Unidades_de_Medida.Unidades_de_Medida obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPost(Spartane.Core.Classes.Unidades_de_Medida.Unidades_de_Medida obj)
        {

            //NEWBUSINESSRULE_AFTERPOST//
        }

        public static bool EjecutarValidacionesBeforePut(Spartane.Core.Classes.Unidades_de_Medida.Unidades_de_Medida obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPut(Spartane.Core.Classes.Unidades_de_Medida.Unidades_de_Medida obj)
        {
        ...
        public static void EjecutarValidacionesAfterDelete(Spartane.Core.Classes.Unidades_de_Medida.Unidades_de_Medida obj)
        {

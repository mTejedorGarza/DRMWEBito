...
{
    public static class Detalle_de_PadecimientosRules
    {
        public static bool EjecutarValidacionesBeforePost(Spartane.Core.Classes.Detalle_de_Padecimientos.Detalle_de_Padecimientos obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPost(Spartane.Core.Classes.Detalle_de_Padecimientos.Detalle_de_Padecimientos obj)
        {

            //NEWBUSINESSRULE_AFTERPOST//
        }

        public static bool EjecutarValidacionesBeforePut(Spartane.Core.Classes.Detalle_de_Padecimientos.Detalle_de_Padecimientos obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPut(Spartane.Core.Classes.Detalle_de_Padecimientos.Detalle_de_Padecimientos obj)
        {
        ...
        public static void EjecutarValidacionesAfterDelete(Spartane.Core.Classes.Detalle_de_Padecimientos.Detalle_de_Padecimientos obj)
        {

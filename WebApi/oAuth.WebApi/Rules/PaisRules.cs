...
{
    public static class PaisRules
    {
        public static bool EjecutarValidacionesBeforePost(Spartane.Core.Classes.Pais.Pais obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPost(Spartane.Core.Classes.Pais.Pais obj)
        {

            //NEWBUSINESSRULE_AFTERPOST//
        }

        public static bool EjecutarValidacionesBeforePut(Spartane.Core.Classes.Pais.Pais obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPut(Spartane.Core.Classes.Pais.Pais obj)
        {

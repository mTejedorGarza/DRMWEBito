...
{
    public static class Detalle_Examenes_LaboratorioRules
    {
        public static bool EjecutarValidacionesBeforePost(Spartane.Core.Classes.Detalle_Examenes_Laboratorio.Detalle_Examenes_Laboratorio obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPost(Spartane.Core.Classes.Detalle_Examenes_Laboratorio.Detalle_Examenes_Laboratorio obj)
        {

            //NEWBUSINESSRULE_AFTERPOST//
        }

        public static bool EjecutarValidacionesBeforePut(Spartane.Core.Classes.Detalle_Examenes_Laboratorio.Detalle_Examenes_Laboratorio obj)
        {
            bool ret = true;
        ...
        public static void EjecutarValidacionesAfterPut(Spartane.Core.Classes.Detalle_Examenes_Laboratorio.Detalle_Examenes_Laboratorio obj)
        {
        ...
        public static void EjecutarValidacionesAfterDelete(Spartane.Core.Classes.Detalle_Examenes_Laboratorio.Detalle_Examenes_Laboratorio obj)
        {

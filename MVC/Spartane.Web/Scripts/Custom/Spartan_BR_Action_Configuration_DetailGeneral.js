...
function ClearControls() {
    $("#ReferenceActionConfigurationId").val("0");
    $('#CreateSpartan_BR_Action_Configuration_Detail')[0].reset();
    ClearFormControls();
    $("#ActionConfigurationIdId").val("0");
...
function ClearFormControls() {
    $('#CreateSpartan_BR_Action_Configuration_Detail').trigger('reset');
    $('#CreateSpartan_BR_Action_Configuration_Detail').find(':input').each(function () {
        switch (this.type) {
            case 'password':
            case 'number':
...
function CheckValidation() {
    var $myForm = $('#CreateSpartan_BR_Action_Configuration_Detail');
...
function ResetClaveLabel() {
    $("#lblActionConfigurationId").text("0");
}
$(document).ready(function () {
    $("form#CreateSpartan_BR_Action_Configuration_Detail").submit(function (e) {
        e.preventDefault();
        return false;
    });
    ...
    $("#Guardar").click(function () {
        if (CheckValidation())
            SendSpartan_BR_Action_Configuration_DetailData(function () {
                BackToGrid();
            });
    });
    ...
    $("#GuardarYCopia").click(function () {
        if (CheckValidation())
            SendSpartan_BR_Action_Configuration_DetailData(function (currentId) {
                $("#ActionConfigurationIdId").val("0");

                ResetClaveLabel();
                $("#ReferenceActionConfigurationId").val(currentId);
...
function DisplayBusinessRule() {
    if (!isdisplayBusinessPropery) {
        $('#CreateSpartan_BR_Action_Configuration_Detail').find('.col-sm-8').each(function () {

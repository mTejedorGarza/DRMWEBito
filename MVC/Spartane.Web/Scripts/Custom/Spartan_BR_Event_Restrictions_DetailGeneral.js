...
function ClearControls() {
    ...
    $('#CreateSpartan_BR_Event_Restrictions_Detail')[0].reset();
    ClearFormControls();
...
function ClearFormControls() {
    $('#CreateSpartan_BR_Event_Restrictions_Detail').trigger('reset');
    $('#CreateSpartan_BR_Event_Restrictions_Detail').find(':input').each(function () {
        switch (this.type) {
            case 'password':
            case 'number':
...
function CheckValidation() {
    var $myForm = $('#CreateSpartan_BR_Event_Restrictions_Detail');
...
$(document).ready(function () {
    $("form#CreateSpartan_BR_Event_Restrictions_Detail").submit(function (e) {
        e.preventDefault();
        return false;
    });
    ...
    $("#Guardar").click(function () {
        if (CheckValidation())
            SendSpartan_BR_Event_Restrictions_DetailData(function () {
                BackToGrid();
            });
    });
    ...
    $("#GuardarYCopia").click(function () {
        if (CheckValidation())
            SendSpartan_BR_Event_Restrictions_DetailData(function (currentId) {
                $("#RestrictionIdId").val("0");
...
function DisplayBusinessRule() {
    if (!isdisplayBusinessPropery) {
        $('#CreateSpartan_BR_Event_Restrictions_Detail').find('.col-sm-8').each(function () {

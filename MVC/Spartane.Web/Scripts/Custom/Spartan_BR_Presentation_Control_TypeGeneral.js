...
function ClearControls() {
    $("#ReferencePresentationControlTypeId").val("0");
    $('#CreateSpartan_BR_Presentation_Control_Type')[0].reset();
    ClearFormControls();
    $("#PresentationControlTypeIdId").val("0");
...
function ClearFormControls() {
    $('#CreateSpartan_BR_Presentation_Control_Type').trigger('reset');
    $('#CreateSpartan_BR_Presentation_Control_Type').find(':input').each(function () {
        switch (this.type) {
            case 'password':
            case 'number':
...
function CheckValidation() {
    var $myForm = $('#CreateSpartan_BR_Presentation_Control_Type');
...
function ResetClaveLabel() {
    $("#lblPresentationControlTypeId").text("0");
}
$(document).ready(function () {
    $("form#CreateSpartan_BR_Presentation_Control_Type").submit(function (e) {
        e.preventDefault();
        return false;
    });
    ...
    $("#Guardar").click(function () {
        if (CheckValidation())
            SendSpartan_BR_Presentation_Control_TypeData(function () {
                BackToGrid();
            });
    });
    ...
    $("#GuardarYCopia").click(function () {
        if (CheckValidation())
            SendSpartan_BR_Presentation_Control_TypeData(function (currentId) {
                $("#PresentationControlTypeIdId").val("0");

                ResetClaveLabel();
                $("#ReferencePresentationControlTypeId").val(currentId);
...
function DisplayBusinessRule() {
    if (!isdisplayBusinessPropery) {
        $('#CreateSpartan_BR_Presentation_Control_Type').find('.col-sm-8').each(function () {

...
{
    public class Solicitud_de_Cita_con_EspecialistaModel
    {
        [Required]
	...
	public class Solicitud_de_Cita_con_Especialista_Datos_GeneralesModel
    {
        [Required]
        public int Folio { get; set; }
        public string Fecha_de_solicitud { get; set; }
	...
	public class Solicitud_de_Cita_con_Especialista_SolicitudModel
    {
        [Required]
        public int Folio { get; set; }
        public string Fecha_de_Retroalimentacion { get; set; }

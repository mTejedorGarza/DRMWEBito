...
{
    public class Interpretacion_Dificultad_de_Rutina_de_EjerciciosAdvanceSearchModel
    {
        public Interpretacion_Dificultad_de_Rutina_de_EjerciciosAdvanceSearchModel()
        {

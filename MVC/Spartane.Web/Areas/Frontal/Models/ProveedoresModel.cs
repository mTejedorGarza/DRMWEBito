...
namespace Spartane.Web.Areas.Frontal.Models
{
	...
	public class Proveedores_Datos_GeneralesModel
    {
        [Required]
        public int Folio { get; set; }
        public string Fecha_de_Registro { get; set; }
	...
	public class Proveedores_Datos_de_ContactoModel
    {
        [Required]
        public int Folio { get; set; }
        public string Nombres { get; set; }
	...
	public class Proveedores_Red_de_ProveedoresModel
    {
        [Required]
        public int Folio { get; set; }
	...
	public class Proveedores_Datos_FiscalesModel
    {
        [Required]
        public int Folio { get; set; }
        public int? Regimen_Fiscal { get; set; }

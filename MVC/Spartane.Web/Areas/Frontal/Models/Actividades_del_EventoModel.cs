...
{
    public class Actividades_del_EventoModel
    {
        [Required]
	...
	public class Actividades_del_Evento_Datos_GeneralesModel
    {
        [Required]
        public int Folio { get; set; }
        public string Fecha_de_Registro { get; set; }
	...
	public class Actividades_del_Evento_AgendaModel
    {
        [Required]
        public int Folio { get; set; }
	...
	public class Actividades_del_Evento_Laboratorios_ClinicosModel
    {
        [Required]
        public int Folio { get; set; }

...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Redes_socialesController : Controller
    {
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)44451, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index(int ModuleId=0)
        {
            ...
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 44451, ModuleId);
        ...
        // GET: Frontal/Redes_sociales/Create
          [ObjectAuth(ObjectId = (ModuleObjectId)44451, PermissionType = PermissionTypes.New,
           ...
           if ((!permission.New && Id.ToString() == "0") || (!permission.Edit && Id.ToString() != "0" && (!permission.Consult && consult == 1)))
            ...
            if ((Id.GetType() == typeof(string) && Id.ToString() != "") || ((Id.GetType() == typeof(int) || Id.GetType() == typeof(Int16) || Id.GetType() == typeof(Int32) || Id.GetType() == typeof(Int64) || Id.GetType() == typeof(short))&& Id.ToString() != "0"))
            {
				...
				if (Redes_socialessData != null && Redes_socialessData.Count > 0)
                {
                    ...
                    ,Direccion_URL = Redes_socialesData.Direccion_URL
	...
	[HttpGet]
        public ActionResult AddRedes_sociales(int rowIndex = 0, int functionMode = 0, string id = "0")
        {
            ...
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 44451);
            ViewBag.Permission = permission;
			if (!_tokenManager.GenerateToken())
                return null;
           _IRedes_socialesApiConsumer.SetAuthHeader(_tokenManager.Token);
...
*/
        ...
        public string GetAdvanceFilter(Redes_socialesAdvanceSearchModel filter)
        {
            ...
            if (!string.IsNullOrEmpty(filter.Direccion_URL))
            {
                switch (filter.Direccion_URLFilter)
                {
                    case Models.Filters.BeginWith:
                        where += " AND Redes_sociales.Direccion_URL LIKE '" + filter.Direccion_URL + "%'";
                        break;
                    ...
                    case Models.Filters.Exact:
                        where += " AND Redes_sociales.Direccion_URL = '" + filter.Direccion_URL + "'";
                        break;
            ...
            try
            {
				...
				//{
                    ...
                    var Redes_socialesInfo = new Redes_sociales
                    {
                        ...
                        ,Direccion_URL = varRedes_sociales.Direccion_URL
        ...
        public ActionResult GetFormats(string RecordId)
        {
           ...
           _ISpartan_FormatApiConsumer.SetAuthHeader(_tokenManager.Token);
            ...
            if (formatsPermisions.RowCount > 0)
            {
                ...
                var whereClauseFormat = "Object = 44451 AND FormatId in (" + formats + ")";
        ...
        public void Export(string format, int pageIndex, int pageSize, string iSortCol, string sSortDir, string where, string order, dynamic columnsVisible)
        {
            ...
            switch (exportFormatType)
            {
                case ExportFormatType.PDF:
                    PdfConverter.ExportToPdf(data.ToDataTable(44451, arrayColumnsVisible), "Redes_socialesList_" + DateTime.Now.ToString());
                    break;

                case ExportFormatType.EXCEL:
                    ExcelConverter.ExportToExcel(data.ToDataTable(44451, arrayColumnsVisible), "Redes_socialesList_" + DateTime.Now.ToString());
                    break;

                case ExportFormatType.CSV:
                    CsvConverter.ExportToCSV(data.ToDataTable(44451, arrayColumnsVisible), "Redes_socialesList_" + DateTime.Now.ToString());
                    break;
            }
        }

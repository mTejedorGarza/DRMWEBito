...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Spartan_BR_Presentation_Control_TypeController : Controller
    {
        ...
        public Spartan_BR_Presentation_Control_TypeController(ISpartan_BR_Presentation_Control_TypeService service,ITokenManager tokenManager, IAuthenticationApiConsumer authenticationApiConsumer, ISpartan_BR_Presentation_Control_TypeApiConsumer Spartan_BR_Presentation_Control_TypeApiConsumer, ISpartane_FileApiConsumer Spartane_FileApiConsumer )
        {
        ...
        // GET: Frontal/Spartan_BR_Presentation_Control_Type
        [ObjectAuth(ObjectId = (ModuleObjectId)147, PermissionType = PermissionTypes.Consult)]
        ...
        // GET: Frontal/Spartan_BR_Presentation_Control_Type/Create
        [ObjectAuth(ObjectId = (ModuleObjectId)147, PermissionType = PermissionTypes.New,
        ...
        [HttpPost]
        public ActionResult ShowAdvanceFilter(Spartan_BR_Presentation_Control_TypeAdvanceSearchModel model)
        {
        ...
        public ActionResult ShowAdvanceFilter(string previousFilters = "")
        {
            ...
            var previousFiltersObj = new Spartan_BR_Presentation_Control_TypeAdvanceSearchModel();
            if (previousFilters != "")
            {
                previousFiltersObj = (Spartan_BR_Presentation_Control_TypeAdvanceSearchModel)(Session["AdvanceSearch"] ?? new Spartan_BR_Presentation_Control_TypeAdvanceSearchModel());
            }
        ...
        public ActionResult Get()
        {
            ...
            if (filter != null)
                configuration = GridQueryHelper.GetConfiguration(filter, new Spartan_BR_Presentation_Control_TypePropertyMapper());

            var pageSize = Convert.ToInt32(filter["pageSize"]);
            var pageIndex = Convert.ToInt32(filter["pageIndex"]);
            var result = _ISpartan_BR_Presentation_Control_TypeApiConsumer.ListaSelAll((pageIndex * pageSize) - pageSize + 1, pageSize, configuration.WhereClause, configuration.OrderByClause ?? "").Resource;
            if (result.Spartan_BR_Presentation_Control_Types == null)
                result.Spartan_BR_Presentation_Control_Types = new List<Spartan_BR_Presentation_Control_Type>();

            return Json(new
            {
                data = result.Spartan_BR_Presentation_Control_Types.Select(m => new Spartan_BR_Presentation_Control_TypeGridModel
                    {
        ...
        /// <summary>
        /// Get List of Spartan_BR_Presentation_Control_Type from Web API.
        /// </summary>
        /// <param name="draw"></param>
        /// <param name="start"></param>
        /// <param name="length"></param>
        /// <returns>Return List of Spartan_BR_Presentation_Control_Type Entity</returns>
        public ActionResult GetSpartan_BR_Presentation_Control_TypeList(int sEcho, int iDisplayStart, int iDisplayLength)
        {
            int sortColumn = -1;
            ...
            var configuration = new GridConfiguration() { OrderByClause = "", WhereClause = "" };
            if (filter != null)
                configuration = GridQueryHelper.GetDataTableConfiguration(filter, new Spartan_BR_Presentation_Control_TypePropertyMapper());

            //Adding Advance Search
            if (!string.IsNullOrEmpty(Request.QueryString["AdvanceSearch"]) && Request.QueryString["AdvanceSearch"] == "True")
            {
                var advanceFilter =
                    (Spartan_BR_Presentation_Control_TypeAdvanceSearchModel)Session["AdvanceSearch"];
                configuration.WhereClause = configuration.WhereClause == "" ? GetAdvanceFilter(advanceFilter) : configuration.WhereClause + " AND " + GetAdvanceFilter(advanceFilter);
            }

            Spartan_BR_Presentation_Control_TypePropertyMapper oSpartan_BR_Presentation_Control_TypePropertyMapper = new Spartan_BR_Presentation_Control_TypePropertyMapper();

            configuration.OrderByClause = oSpartan_BR_Presentation_Control_TypePropertyMapper.GetPropertyName(Convert.ToString(Request.QueryString["mDataProp_" + sortColumn])) + " " + sortDirection;

            var pageSize = iDisplayLength;
            var pageIndex = (iDisplayStart / iDisplayLength) + 1;
            var result = _ISpartan_BR_Presentation_Control_TypeApiConsumer.ListaSelAll((pageIndex * pageSize) - pageSize + 1, pageSize + ((pageIndex * pageSize) - pageSize), configuration.WhereClause, configuration.OrderByClause ?? "").Resource;
            if (result.Spartan_BR_Presentation_Control_Types == null)
                result.Spartan_BR_Presentation_Control_Types = new List<Spartan_BR_Presentation_Control_Type>();

            return Json(new
            {
                aaData = result.Spartan_BR_Presentation_Control_Types.Select(m => new Spartan_BR_Presentation_Control_TypeGridModel
            {
                    PresentationControlTypeId = m.PresentationControlTypeId
			,Description = m.Description
        ...
        [NonAction]
        public string GetAdvanceFilter(Spartan_BR_Presentation_Control_TypeAdvanceSearchModel filter)
        {
            var where = "";
            if (!string.IsNullOrEmpty(filter.FromPresentationControlTypeId) || !string.IsNullOrEmpty(filter.ToPresentationControlTypeId))
            {
                if (!string.IsNullOrEmpty(filter.FromPresentationControlTypeId))
                    where += " AND Spartan_BR_Presentation_Control_Type.PresentationControlTypeId >= " + filter.FromPresentationControlTypeId;
                if (!string.IsNullOrEmpty(filter.ToPresentationControlTypeId))
                    where += " AND Spartan_BR_Presentation_Control_Type.PresentationControlTypeId <= " + filter.ToPresentationControlTypeId;
            }
            ...
            if (!string.IsNullOrEmpty(filter.Description))
            {
                switch (filter.DescriptionFilter)
                {
                    case Models.Filters.BeginWith:
                        where += " AND Spartan_BR_Presentation_Control_Type.Description LIKE '" + filter.Description + "%'";
                        break;
                    ...
                    case Models.Filters.Exact:
                        where += " AND Spartan_BR_Presentation_Control_Type.Description = '" + filter.Description + "'";
                        break;
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                ...
                //Spartan_BR_Presentation_Control_Type varSpartan_BR_Presentation_Control_Type = null;
                if (id.ToString() != "0")
                {

                }
                var result = _ISpartan_BR_Presentation_Control_TypeApiConsumer.Delete(id, null, null).Resource;
        ...
        /// <summary>
        /// Write Element Array of Spartan_BR_Presentation_Control_Type script
        /// </summary>
        /// <param name="oSpartan_BR_Presentation_Control_TypeElements"></param>
        /// <returns></returns>
        [HttpPost]
        ...
        public JsonResult ReadScriptSettings()
        {
            ...
            if (System.IO.File.Exists(Server.MapPath("~/Uploads/Scripts/Spartan_BR_Presentation_Control_Type.js")))
            {
                using (StreamReader r = new StreamReader(Server.MapPath("~/Uploads/Scripts/Spartan_BR_Presentation_Control_Type.js")))
                {
        ...
        [HttpGet]
        public ActionResult Spartan_BR_Presentation_Control_TypePropertyBag()
        {
            return PartialView("Spartan_BR_Presentation_Control_TypePropertyBag", "Spartan_BR_Presentation_Control_Type");
        }

        [HttpGet]
        public ActionResult Spartan_BR_Presentation_Control_TypeBusinessRule()
        {
            return PartialView("Spartan_BR_Presentation_Control_TypeBusinessRule", "Spartan_BR_Presentation_Control_Type");
        }

        [HttpGet]
        public ActionResult AddBusinessRule(int BusinessRuleId = 0)
        {
            Spartan_BR_Presentation_Control_TypeBusinessRuleModel oSpartan_BR_Presentation_Control_TypeBusinessRuleModel = new Spartan_BR_Presentation_Control_TypeBusinessRuleModel();
            if (BusinessRuleId > 0)
            {
                oSpartan_BR_Presentation_Control_TypeBusinessRuleModel.BusinessRuleId = BusinessRuleId;
            }
            return PartialView("AddBusinessRule", oSpartan_BR_Presentation_Control_TypeBusinessRuleModel);
        }
        ...
        public void Export(string format, int pageIndex, int pageSize)
        {
            ...
            var data = result.Spartan_BR_Presentation_Control_Types.Select(m => new Spartan_BR_Presentation_Control_TypeGridModel
            {
                PresentationControlTypeId = m.PresentationControlTypeId
                ,Description = m.Description
            ...
            switch (exportFormatType)
            {
                case ExportFormatType.PDF:
                    PdfConverter.ExportToPdf(data.ToDataTable(), "Spartan_BR_Presentation_Control_TypeList_" + DateTime.Now.ToString());
                    break;

                case ExportFormatType.EXCEL:
                    ExcelConverter.ExportToExcel(data.ToDataTable(), "Spartan_BR_Presentation_Control_TypeList_" + DateTime.Now.ToString());
                    break;

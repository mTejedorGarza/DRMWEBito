...
namespace Resources
{
    public partial class Spartan_BR_Actions_True_DetailResources
    {
        ...
        {
            resourceProviderSpartan_BR_Actions_True_Detail = new XmlResourceProvider(Path.Combine(ConfigurationManager.AppSettings["BaseDirectoyPhysical"].ToString(), @"Uploads\Resources\Spartan_BR_Actions_True_DetailResource." + CultureInfo.CurrentUICulture.Name + ".xml"));
        }
        ...
        public static string Parameter_3
        {
            ...
            {
                SetPath();
                return resourceProviderSpartan_BR_Actions_True_Detail.GetResource("Parameter_3", CultureInfo.CurrentUICulture.Name) as String;
            }
        }
        ...
        public static string Parameter_4
        {
            ...
            {
                SetPath();
                return resourceProviderSpartan_BR_Actions_True_Detail.GetResource("Parameter_4", CultureInfo.CurrentUICulture.Name) as String;
            }
        }

...
{
    public class Subgrupos_IngredientesPropertyMapper : ISqlPropertyMapper
    {
        public string GetPropertyName(string propertyName)
        {
            ...
            {
                case "Folio":
                    return "Subgrupos_Ingredientes.Folio";
                case "Nombre":
        ...
        {
            var t = (typeof(Subgrupos_Ingredientes).GetProperty(columnName));

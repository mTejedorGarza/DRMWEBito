...
{
    public class Spartan_BR_Operator_TypePropertyMapper : ISqlPropertyMapper
    {
        public string GetPropertyName(string propertyName)
        {
            ...
            {
                case "OperatorTypeId":
                    return "Spartan_BR_Operator_Type.OperatorTypeId";
                case "Description":
                ...
                case "Query_for_Fill_Condition":
                    return "Spartan_BR_Operator_Type.Query_for_Fill_Condition";
                case "Code_for_Fill_Condition":
                    return "Spartan_BR_Operator_Type.Code_for_Fill_Condition";
                case "Implementation_Code":
                    return "Spartan_BR_Operator_Type.Implementation_Code";

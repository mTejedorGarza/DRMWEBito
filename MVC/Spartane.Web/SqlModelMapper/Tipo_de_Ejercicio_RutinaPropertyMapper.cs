...
{
    public class Tipo_de_Ejercicio_RutinaPropertyMapper : ISqlPropertyMapper
    {
        ...
        {
            var t = (typeof(Tipo_de_Ejercicio_Rutina).GetProperty(columnName));

...
namespace Spartane.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            #region QUnit
            bundles.Add(new StyleBundle("~/Content/qqunit/css")
                .Include("~/Content/qunit.css"));
            bundles.Add(new StyleBundle("~/bundles/qqunit/js")
            ...
            bundles.Add(new StyleBundle("~/plugins/ScrollBarStyles").Include(
                      "~/Content/plugins/ScrollBar/jquery.mCustomScrollbar.css"));

            bundles.Add(new ScriptBundle("~/plugins/CustomScroll").Include(
            ...
            bundles.Add(new ScriptBundle("~/Content/plugins/jsTree").Include(
                     "~/Content/plugins/jsTree/style.min.cs"));
            ...
            // moment 
            bundles.Add(new ScriptBundle("~/BootstrapDatePicker/moment").Include(
                      "~/Scripts/BootstrapDatePicker/moment.js"));
            ...
            //automatic_report
            bundles.Add(new ScriptBundle("~/plugins/automatic-report")
                .Include("~/Scripts/plugins/automatic-report/jquery.dataTables.min.js")
                .Include("~/Scripts/plugins/automatic-report/dataTables.select.min.js")
                .Include("~/Scripts/plugins/automatic-report/dataTables.buttons.min.js")
                .Include("~/Scripts/plugins/automatic-report/jszip.min.js")
                .Include("~/Scripts/plugins/automatic-report/pdfmake.min.js")
                .Include("~/Scripts/plugins/automatic-report/vfs_fonts.js")
                .Include("~/Scripts/plugins/automatic-report/buttons.html5.min.js")
                .Include("~/Scripts/plugins/automatic-report/buttons.print.min.js")
                .Include("~/Scripts/Custom/tablePlugin.js"));

...
namespace Spartane.Core.Domain.Solicitud_de_Pago_de_Facturas
{
    /// <summary>
    ...
    public class Solicitud_de_Pago_de_Facturas: BaseEntity
    {
        ...
        public virtual Spartane.Core.Domain.Meses.Meses Mes_Facturado_Meses { get; set; }
        ...
        public virtual Spartane.Core.Domain.Spartane_File.Spartane_File Recibo_de_Solicitud_de_Pago_Spartane_File { get; set; }
        [ForeignKey("Estatus")]
        ...
        public virtual Spartane.Core.Domain.Resultados_de_Revision.Resultados_de_Revision Resultado_de_la_Revision_Resultados_de_Revision { get; set; }
        [ForeignKey("Usuario_que_programa")]
        public virtual Spartane.Core.Domain.Spartan_User.Spartan_User Usuario_que_programa_Spartan_User { get; set; }
        [ForeignKey("Estatus_de_Pago")]
        public virtual Spartane.Core.Domain.Estatus_de_Pago_de_Facturas.Estatus_de_Pago_de_Facturas Estatus_de_Pago_Estatus_de_Pago_de_Facturas { get; set; }
        [ForeignKey("Usuario_que_actualiza")]
        public virtual Spartane.Core.Domain.Spartan_User.Spartan_User Usuario_que_actualiza_Spartan_User { get; set; }

    }
	
	public class Solicitud_de_Pago_de_Facturas_Datos_Generales
    {
                public int Folio { get; set; }
        public DateTime? Fecha_de_Registro { get; set; }
        public string Hora_de_Registro { get; set; }
	...
	public class Solicitud_de_Pago_de_Facturas_Autorizacion
    {
                public int Folio { get; set; }
        public DateTime? Fecha_de_autorizacion { get; set; }
        public string Hora_de_autorizacion { get; set; }
	...
	public class Solicitud_de_Pago_de_Facturas_Programacion_de_Pago
    {
                public int Folio { get; set; }
        public DateTime? Fecha_de_programacion { get; set; }
        public string Hora_de_programacion { get; set; }
	...
	public class Solicitud_de_Pago_de_Facturas_Pago
    {
                public int Folio { get; set; }
        public DateTime? Fecha_de_actualizacion { get; set; }
        public string Hora_de_actualizacion { get; set; }

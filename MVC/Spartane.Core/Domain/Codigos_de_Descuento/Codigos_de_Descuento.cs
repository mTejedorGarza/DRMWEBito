...
namespace Spartane.Core.Domain.Codigos_de_Descuento
{
    ...
    public class Codigos_de_Descuento: BaseEntity
    {
        ...
        public virtual Spartane.Core.Domain.Tipos_de_Descuento.Tipos_de_Descuento Tipo_de_Descuento_Tipos_de_Descuento { get; set; }
        [ForeignKey("Estatus")]
        public virtual Spartane.Core.Domain.Estatus_de_Codigos_de_Descuento.Estatus_de_Codigos_de_Descuento Estatus_Estatus_de_Codigos_de_Descuento { get; set; }
        ...
        public virtual Spartane.Core.Domain.Resultado_de_Autorizacion.Resultado_de_Autorizacion Resultado_Resultado_de_Autorizacion { get; set; }

    }
	
	public class Codigos_de_Descuento_Datos_Generales
    {
                public int Folio { get; set; }
        public DateTime? Fecha_de_Registro { get; set; }
        public string Hora_de_Registro { get; set; }
	...
	public class Codigos_de_Descuento_Autorizacion
    {
                public int Folio { get; set; }
        public DateTime? Fecha_de_autorizacion { get; set; }
        public string Hora_de_autorizacion { get; set; }
	...
	public class Codigos_de_Descuento_Referenciados
    {
                public int Folio { get; set; }

...
namespace Spartane.Core.Domain.MR_Tarjetas
{
    ...
    public class MR_Tarjetas: BaseEntity
    {
        ...
        public virtual Spartane.Core.Domain.Metodos_de_Pago_Paciente.Metodos_de_Pago_Paciente Folio_Metodos_de_Pago_Paciente_Metodos_de_Pago_Paciente { get; set; }
        [ForeignKey("Tipo_de_Tarjeta")]
        public virtual Spartane.Core.Domain.Tipo_de_Tarjeta.Tipo_de_Tarjeta Tipo_de_Tarjeta_Tipo_de_Tarjeta { get; set; }
        [ForeignKey("Estatus")]
        public virtual Spartane.Core.Domain.Estatus.Estatus Estatus_Estatus { get; set; }

    }
	
	public class MR_Tarjetas_Datos_Generales
    {
                public int Folio { get; set; }
        public int? Folio_Metodos_de_Pago_Paciente { get; set; }
        public int? Tipo_de_Tarjeta { get; set; }

...
{
    public partial class TTTemplatePrintExcelFieldService : ITTTemplatePrintExcelFieldService
    {
        public readonly int iProcess = 6583;

        #region Fields
        private readonly IRepository<TTTemplatePrintExcelField> _ttRepository;
        ...
        public TTTemplatePrintExcelFieldService(IRepository<TTTemplatePrintExcelField> ttRepository, IDataProvider dataProvider, IDbContext dbContext, ITTSearchAdvancedDataService tTSearchAdvancedDataService)
        {
        ...
        public IList<TTTemplatePrintExcelField> SelAll(bool ConRelaciones)
        {
            return this._ttRepository.Table.ToList();
        }

        public IList<TTTemplatePrintExcelField> SelAll(bool ConRelaciones, int CurrentRecordInt32, int RecordsDisplayedInt32)
        {
            return this._ttRepository.Table.ToList();
        }
        ...
        public TTTemplatePrintExcelField GetByKey(int? Key, bool ConRelaciones)
        {
        ...
        public int Insert(TTTemplatePrintExcelField entity, Core.Domain.User.GlobalData UserInformation, Core.Domain.Data.DataLayerFieldsBitacora DataReference)
        {
            var rta = 0;
            try
            {
        ...
        public int Update(TTTemplatePrintExcelField entity, Core.Domain.User.GlobalData UserInformation, Core.Domain.Data.DataLayerFieldsBitacora DataReference)
        {
            var rta = 0;
            try
            {
        ...
        {
            var columns = _dbContext.ExecuteStoredProcedureList<sp_selTTTemplatePrintExcel_Campos_Relacion_TTDNT_Result>(
                "sp_selTTTemplatePrintExcel_Campos_Relacion_TTDNT");
        ...
        public void FillDataDTID(Object ctr)
        {
            var columns = _dbContext.ExecuteStoredProcedureList<sp_selTTTemplatePrintExcel_Campos_Relacion_TTMetadata_Result>(
                "sp_selTTTemplatePrintExcel_Campos_Relacion_TTMetadata");
        ...
        public void FillDataDTID(Object ctr, int Key)
        {
            var columns = _dbContext.ExecuteStoredProcedureList<sp_selTTTemplatePrintExcel_Campos_Relacion_TTMetadata_Result>(
                "sp_selTTTemplatePrintExcel_Campos_Relacion_TTMetadata");
        ...
        public void applyFilterToObject(IList<TTTemplatePrintExcelField> filters, Core.Domain.Search.TTSearchAdvancedDataDetails tTSearchAdvancedDataDetails, int indexFilter)
        {
        ...
        public IList<TTSearchAdvancedData> FiltersObligatories(Core.Domain.User.GlobalData GlobalInformation)
        {
            ...
            var filters = new List<TTTemplatePrintExcelField>();
        ...
        public void AddFilterXDT(IList<TTTemplatePrintExcelField> filters, string sDTid, object filter, int indexFilter)
        {
            //if (sDTid == "14077")
            //{
